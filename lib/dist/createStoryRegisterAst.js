...
exports.createStoryRegisterAst = function (props) { return [
    ...
    ts.createExpressionStatement(ts.createCall(ts.createIdentifier(props.declarationName), undefined, [
        ts.createCall(ts.createIdentifier('storiesOf'), undefined, [
